...
| UI-HEALTH-02 | `tests/lab-01/ui-health.test.tsx` | Vitest + React Testing Library | Clicking Check System when the backend is unavailable shows an error message. | "System Status: Offline" and "Unable to connect to TokTickIT API" are shown. |
